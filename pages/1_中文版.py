...
with col12:
    ...
    st.write("<span style='font-family: Times New Roman; font-size: 19px; color: gray;'>[7] H.Ming, **H.Zhang**, N.Cui*. Battery life estimation method based on forward adaptive width learning, ***Energy***, ***SCI-Q1***, ***TOP***, ***IF=9*** </span><span style='font-family: Times New Roman; font-size: 19px; color: blue;'>[Draft]</span>",
             unsafe_allow_html=True)
    st.write("<span style='font-family: Times New Roman; font-size: 19px; color: gray;'>[8] **H.Zhang**, L.Zhang, GY.Fan, J.Chen, B.Sun*. Research and application of heating pipe network modeling framework based on physical information network. ***Engineering Applications Of Artificial Intelligence***, ***SCI-Q2***, ***TOP***, ***IF=8*** </span><span style='font-family: Times New Roman; font-size: 19px; color: red;'>[Writing]</span>",
             unsafe_allow_html=True)
    st.write("<span style='font-family: Times New Roman; font-size: 19px; color: gray;'>[9] **H.Zhang**, LZ.Zhang, GY.Fan, B.Jia, B.Sun*. Hydrogen-containing integrated energy system architecture search algorithm based on reinforcement learning. ***IEEE Transactions on Industrial Informatics***, ***SCI-Q1***, ***TOP***, IF=12.3 </span><span style='font-family: Times New Roman; font-size: 19px; color: red;'>[Writing]</span>",
             unsafe_allow_html=True)
    st.write("<span style='font-family: Times New Roman; font-size: 19px; color: gray;'>[10] **H.Zhang**, B.Sun*, XF.Li. Research and application of a physically constrained data-driven modeling method for hydrogen leakage and diffusion in confined spaces. ***NATURE METHODS***, ***SCI-Q1***, ***TOP***, ***IF=48*** </span><span style='font-family: Times New Roman; font-size: 19px; color: green;'>[Writing]</span>",
             unsafe_allow_html=True)
    st.write("<span style='font-family: Times New Roman; font-size: 19px; color: gray;'>[11] MR.Qi, **H.Zhang**, XY.Li*. Research and application of interpretable prediction framework for diabetes risk based on fuzzy logic. ***International Journal of Nursing Studies***, ***SCI-Q1***, ***TOP***, ***IF=8.1*** </span><span style='font-family: Times New Roman; font-size: 19px; color: gray;'>[Writing]</span>",
             unsafe_allow_html=True)
    st.write("<span style='font-family: Times New Roman; font-size: 19px; color: gray;'>[12] JW.Zhu, **H.Zhang** .et al. Food safety detection method based on deep fuzzy system. ***LWT***, ***SCI-Q1***, ***TOP***, ***IF=6*** </span><span style='font-family: Times New Roman; font-size: 19px; color: gray;'>[Writing]</span>",
             unsafe_allow_html=True)
    st.write("<span style='font-family: Times New Roman; font-size: 19px; color: gray;'>[13] GY.Fan, **H.Zhang** .et al. Food safety detection method based on deep fuzzy system. ***NATURE COMUNACATIONS***, ***SCI-Q1***, ***TOP***, ***IF=17.646*** </span><span style='font-family: Times New Roman; font-size: 19px; color: gray;'>[Writing]</span>",
             unsafe_allow_html=True)
