...
with col12:
    ...
    st.write("<span style='font-family: Times New Roman; font-size: 19px; color: gray;'>[1] **张辉**, 基于深度模糊系统方法的多变量时间序列预测方法研究及应用, 工学学士学位论文, 指导老师:彭伟, 2022年优秀学士学位论文 </span><span style='font-family: Times New Roman; font-size: 19px; color: blue;'>[Accept]</span>",
             unsafe_allow_html=True)
    ...
    st.write("<span style='font-family: Times New Roman; font-size: 19px; color: gray;'>[4] **H.Zhang**, B.Sun and W.Peng*. A novel hybrid deep fuzzy model based on gradient descent algorithm with application to time series forecasting, ***Expert Systems with Applications***, 2023, doi:10.1016/j.eswa.2023.121988, ***SCI-Q1***, ***TOP***, ***IF=8.5*** </span><span style='font-family: Times New Roman; font-size: 19px; color: blue;'>[Accept]</span>",
             unsafe_allow_html=True)
    st.write("<span style='font-family: Times New Roman; font-size: 19px; color: gray;'>[5] L.Zhang, **H.Zhang**, F.Li and B.Sun*. Bi-level Optimal Design of Integrated Energy System with Synergy of Renewables, Conversion, Storage and Demand, ***IEEE TRANSACTIONS ON INDUSTRY APPLICATIONS***, ***SCI-Q2***, ***IF=4.4*** </span><span style='font-family: Times New Roman; font-size: 19px; color: blue;'>[Under review]</span>",
             unsafe_allow_html=True)
    st.write("<span style='font-family: Times New Roman; font-size: 19px; color: gray;'>[6] **H.Zhang**, KV.Gao, W.Peng*. Mini-Batch Forward Automatic Differentiation based on Efficient Adaptive Optimization Algorithm for TSK Fuzzy Systems, ***IEEE TRANSACTIONS ON FUZYY SYSTEMS***, ***SCI-Q1***, ***TOP***, ***IF=11.9*** </span><span style='font-family: Times New Roman; font-size: 19px; color: blue;'>[Draft]</span>",
             unsafe_allow_html=True)
    st.write("<span style='font-family: Times New Roman; font-size: 19px; color: gray;'>[7] H.Ming, **H.Zhang**, N.Cui*. Battery life estimation method based on forward adaptive width learning, ***Energy***, ***SCI-Q1***, ***TOP***, ***IF=9*** </span><span style='font-family: Times New Roman; font-size: 19px; color: blue;'>[Draft]</span>",
             unsafe_allow_html=True)
    st.write("<span style='font-family: Times New Roman; font-size: 19px; color: gray;'>[8] **H.Zhang**, L.Zhang, B.Sun*. Research and application of heating pipe network modeling framework based on physical information network. ***Engineering Applications Of Artificial Intelligence***, ***SCI-Q2***, ***TOP***, ***IF=8*** </span><span style='font-family: Times New Roman; font-size: 19px; color: blue;'>[Writing]</span>",
             unsafe_allow_html=True)
    st.write("<span style='font-family: Times New Roman; font-size: 19px; color: gray;'>[9] **H.Zhang**, LZ.Zhang, GY.Fan, B.Jia, B.Sun*. Hydrogen-containing integrated energy system architecture search algorithm based on reinforcement learning. ***IEEE Transactions on Industrial Informatics***, ***SCI-Q1***, ***TOP***, IF=12.3 </span><span style='font-family: Times New Roman; font-size: 19px; color: blue;'>[Writing]</span>",
             unsafe_allow_html=True)
    st.write("<span style='font-family: Times New Roman; font-size: 19px; color: gray;'>[10] MR.Qi, **H.Zhang**, XY.Li*. Research and application of interpretable prediction framework for diabetes risk based on fuzzy logic. ***International Journal of Nursing Studies***, ***SCI-Q1***, ***TOP***, ***IF=8.1*** </span><span style='font-family: Times New Roman; font-size: 19px; color: blue;'>[Writing]</span>",
             unsafe_allow_html=True)
    st.write("<span style='font-family: Times New Roman; font-size: 19px; color: gray;'>[11] **H.Zhang**, B.Sun*, XF.Li. Research and application of a physically constrained data-driven modeling method for hydrogen leakage and diffusion in confined spaces. ***NATURE METHODS***, ***SCI-Q1***, ***TOP***, ***IF=48*** </span><span style='font-family: Times New Roman; font-size: 19px; color: blue;'>[Writing]</span>",
             unsafe_allow_html=True)
    st.write("<span style='font-family: Times New Roman; font-size: 19px; color: gray;'>[12] JW.Zhu, **H.Zhang** .et al. Food safety detection method based on deep fuzzy system. ***LWT***, ***SCI-Q1***, ***TOP***, ***IF=6*** </span><span style='font-family: Times New Roman; font-size: 19px; color: blue;'>[Writing]</span>",
             unsafe_allow_html=True)
    st.write("<span style='font-family: Times New Roman; font-size: 19px; color: gray;'>[13] GY.Fan, **H.Zhang** .et al. Food safety detection method based on deep fuzzy system. ***NATURE COMUNACATIONS***, ***SCI-Q1***, ***TOP***, ***IF=17.646*** </span><span style='font-family: Times New Roman; font-size: 19px; color: blue;'>[Writing]</span>",
             unsafe_allow_html=True)
