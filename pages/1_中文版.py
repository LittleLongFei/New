...
with col12:
    ...
    st.write("<span style='font-family: Times New Roman; font-size: 19px; color: gray;'>[1] **张辉**, 基于深度模糊系统方法的多变量时间序列预测方法研究及应用, 工学学士学位论文, 指导老师:彭伟, 2022年优秀学士学位论文 </span><span style='font-family: Times New Roman; font-size: 19px; color: blue;'>[已发表]</span>",
             unsafe_allow_html=True)
    st.write("<span style='font-family: Times New Roman; font-size: 19px; color: gray;'>[2] **张辉**, 彭伟. Time Series Forecasting Based on Interval Type-2 Fuzzy Logic System with PSO, 2021 China Automation Congress (CAC), Beijing, China, 2021, pp. 3090-3097, doi: 10.1109/CAC53003.2021.9727414. ***EI*** </span><span style='font-family: Times New Roman; font-size: 19px; color: blue;'>[已发表]</span>",
             unsafe_allow_html=True)
    st.write("<span style='font-family: Times New Roman; font-size: 19px; color: gray;'>[3] **张辉**, 孙波, 张立志, 张良 .et al. Interval Type-2 Fuzzy Logic System Based on Batch Normalization and Uniform Regularization with Application to Time Series Forecasting, 2023 China Automation Congress (CAC), Chongqing, China, 2023. ***EI*** </span><span style='font-family: Times New Roman; font-size: 19px; color: blue;'>[已发表]</span>",
             unsafe_allow_html=True)
    st.write("<span style='font-family: Times New Roman; font-size: 19px; color: gray;'>[4] **张辉**, 孙波 and 彭伟*. A novel hybrid deep fuzzy model based on gradient descent algorithm with application to time series forecasting, ***Expert Systems with Applications***, 2023, doi:10.1016/j.eswa.2023.121988, ***SCI-Q1***, ***TOP***, ***IF=8.5*** </span><span style='font-family: Times New Roman; font-size: 19px; color: blue;'>[已发表]</span>",
             unsafe_allow_html=True)
    st.write("<span style='font-family: Times New Roman; font-size: 19px; color: gray;'>[5] 张立志, **张辉**, 李帆 and 孙波*. Bi-level Optimal Design of Integrated Energy System with Synergy of Renewables, Conversion, Storage and Demand, ***IEEE TRANSACTIONS ON INDUSTRY APPLICATIONS***, ***SCI-Q2***, ***IF=4.4*** </span><span style='font-family: Times New Roman; font-size: 19px; color: blue;'>[审稿中]</span>",
             unsafe_allow_html=True)
    st.write("<span style='font-family: Times New Roman; font-size: 19px; color: gray;'>[6] **张辉**, 彭伟*, 高凯文, 范光瑶. Mini-Batch Forward Automatic Differentiation based on Efficient Adaptive Optimization Algorithm for TSK Fuzzy Systems, ***IEEE TRANSACTIONS ON FUZYY SYSTEMS***, ***SCI-Q1***, ***TOP***, ***IF=11.9*** </span><span style='font-family: Times New Roman; font-size: 19px; color: blue;'>[审稿中]</span>",
             unsafe_allow_html=True)
    st.write("<span style='font-family: Times New Roman; font-size: 19px; color: gray;'>[7] 明昊宇, **张辉**, 崔纳新*. Battery life estimation method based on forward adaptive width learning, ***Energy***, ***SCI-Q1***, ***TOP***, ***IF=9*** </span><span style='font-family: Times New Roman; font-size: 19px; color: blue;'>[准备提交]</span>",
             unsafe_allow_html=True)
    st.write("<span style='font-family: Times New Roman; font-size: 19px; color: gray;'>[8] **张辉**, 张立志, 贾斌, 范光瑶, 孙波*. Hydrogen-containing integrated energy system architecture search algorithm based on reinforcement learning. ***IEEE TRANSACTIONS ON INDUUSTRIAL INFORMATIONS***, ***SCI-Q1***, ***TOP***, IF=12.3 </span><span style='font-family: Times New Roman; font-size: 19px; color: red;'>[正在写]</span>",
             unsafe_allow_html=True)
    st.write("<span style='font-family: Times New Roman; font-size: 19px; color: gray;'>[9] **张辉**, 张良, 范光瑶, 陈晶, 孙波*. Research and application of heating pipe network modeling framework based on physical information network. ***Engineering Applications of Artificial Intelligence***, ***SCI-Q2***, ***TOP***, ***IF=8*** </span><span style='font-family: Times New Roman; font-size: 19px; color: red;'>[正在写]</span>",
             unsafe_allow_html=True)
    st.write("<span style='font-family: Times New Roman; font-size: 19px; color: gray;'>[10] 范光瑶, **张辉**, 孙波*. Economic Modeling and Analysis of China's Hydrogen Energy System. ***Nature Communications***, ***SCI-Q1***, ***TOP***, ***IF=16.6*** </span><span style='font-family: Times New Roman; font-size: 19px; color: red;'>[正在写]</span>",
             unsafe_allow_html=True)
    st.write("<span style='font-family: Times New Roman; font-size: 19px; color: gray;'>[11] **张辉**, 张嘉欣, 孙波*, 李雪芳. Research and application of a physically constrained data-driven modeling method for hydrogen leakage and diffusion in confined spaces. ***NATURE METHODS***, ***SCI-Q1***, ***TOP***, ***IF=48*** </span><span style='font-family: Times New Roman; font-size: 19px; color: green;'>[调试中]</span>",
             unsafe_allow_html=True)
    st.write("<span style='font-family: Times New Roman; font-size: 19px; color: gray;'>[12] 齐美荣, **张辉**, 李晓燕*. Research and application of interpretable prediction framework for diabetes risk based on fuzzy logic. ***International Journal of Nursing Studies***, ***SCI-Q1***, ***TOP***, ***IF=8.1*** </span><span style='font-family: Times New Roman; font-size: 19px; color: green;'>[调试中]</span>",
             unsafe_allow_html=True)
