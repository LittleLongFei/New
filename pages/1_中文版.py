...
with col12:
    ...
    st.write("<span style='font-family: Times New Roman; font-size: 19px; color: gray;'>[5] LZ.Zhang, **H.Zhang**, F.Li and B.Sun*. Bi-level Optimal Design of Integrated Energy System with Synergy of Renewables, Conversion, Storage and Demand, ***IEEE TRANSACTIONS ON INDUSTRY APPLICATIONS***, ***SCI-Q2***, ***IF=4.4*** </span><span style='font-family: Times New Roman; font-size: 19px; color: blue;'>[Under review]</span>",
             unsafe_allow_html=True)
    st.write("<span style='font-family: Times New Roman; font-size: 19px; color: gray;'>[6] **H.Zhang**, KV.Gao, W.Peng*, CD.Li. Mini-Batch Forward Automatic Differentiation based on Efficient Adaptive Optimization Algorithm for TSK Fuzzy Systems, ***IEEE TRANSACTIONS ON FUZYY SYSTEMS***, ***SCI-Q1***, ***TOP***, ***IF=11.9*** </span><span style='font-family: Times New Roman; font-size: 19px; color: blue;'>[submitted]</span>",
             unsafe_allow_html=True)
    st.write("<span style='font-family: Times New Roman; font-size: 19px; color: gray;'>[7] H.Ming, **H.Zhang**, N.Cui*. Battery life estimation method based on forward adaptive width learning, ***Energy***, ***SCI-Q1***, ***TOP***, ***IF=9*** </span><span style='font-family: Times New Roman; font-size: 19px; color: blue;'>[submitted]</span>",
             unsafe_allow_html=True)
